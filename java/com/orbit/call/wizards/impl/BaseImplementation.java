...
import com.orbit.call.models.Filter;
import com.orbit.call.prefs.GenericPrefs;
import com.orbit.call.utils.Log;
import com.orbit.call.utils.PreferencesWrapper;
import com.orbit.call.wizards.BasePrefsWizard;
import com.orbit.call.wizards.WizardIface;
...
public abstract class BaseImplementation implements WizardIface {
	...
	protected boolean isEmpty(EditTextPreference edt){
		if(edt.getText() == null || edt.getText().equals("")){
			return true;
		}
