...
import com.orbit.call.entities.Conversation;
import com.orbit.call.entities.MucOptions;
import com.orbit.call.entities.Presences;
import com.orbit.call.services.AvatarService;
import com.orbit.call.services.XmppConnectionService;
import com.orbit.call.ui.ChooseContactActivity;
import com.orbit.call.ui.ContactDetailsActivity;
import com.orbit.call.ui.ConversationActivity;
import com.orbit.call.ui.EditAccountActivity;
import com.orbit.call.ui.ManageAccountActivity;
import com.orbit.call.ui.SettingsActivity;
import com.orbit.call.ui.UiCallback;
import com.orbit.call.utils.ExceptionHelper;
import com.orbit.call.xmpp.OnUpdateBlocklist;
import com.orbit.call.xmpp.jid.InvalidJidException;
import com.orbit.call.xmpp.jid.Jid;
...
public abstract class XmppFragment extends Fragment {
    ...
    protected void refreshUi() {
        ...
        if (diff > Config.REFRESH_UI_INTERVAL) {
            ...
            getActivity().runOnUiThread(mRefreshUiRunnable);
        } else {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ExceptionHelper.init(getActivity().getApplicationContext());
    ...
    private void switchToConversation(Conversation conversation, String text, String nick, boolean newTask) {
        Intent viewConversationIntent = new Intent(getActivity(),
                ConversationActivity.class);
        viewConversationIntent.setAction(Intent.ACTION_VIEW);
        viewConversationIntent.putExtra(ConversationActivity.CONVERSATION,
                conversation.getUuid());
        viewConversationIntent.putExtra("jid",
                conversation.getJid().toString());
        if (text != null) {
    ...
    public void switchToContactDetails(com.orbit.call.entities.Contact contact) {
                ...
                "online", new UiCallback<Account>() {
                    ...
                    public void success(Account account) {
                        ...
                        if (conversation != null) {
                            conversation
                                    .setNextEncryption(com.orbit.call.entities.Message.ENCRYPTION_PGP);
                            xmppConnectionService.databaseBackend
    ...
    protected void showAddToRosterDialog(final com.orbit.call.entities.Contact contact) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        ...
        builder.setPositiveButton(getString(R.string.add_contact),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        com.orbit.call.entities.Contact contact = account.getRoster().getContact(jid);
    ...
    private void showAskForPresenceDialog(final com.orbit.call.entities.Contact contact) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        builder.setTitle(contact.getJid().toString());
    ...
    private void quickEdit(final String previousValue,
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        View view = getActivity().getLayoutInflater().inflate(R.layout.quickedit, null);
        ...
        if (password) {
            ...
            {
                builder.setPositiveButton("Editar", mClickListener);
            }
            ...
            {
                builder.setPositiveButton("Edit", mClickListener);
            }
    ...
    public void selectPresence(final Conversation conversation,
                               final OnPresenceSelected listener) {
        final com.orbit.call.entities.Contact contact = conversation.getContact();
        if (conversation.hasValidOtrSession()) {
            ...
            if (presences.size() == 0) {
                if (!contact.getOption(com.orbit.call.entities.Contact.Options.TO)
                        && !contact.getOption(com.orbit.call.entities.Contact.Options.ASKING)
                        && contact.getAccount().getStatus() == Account.State.ONLINE) {
                    showAskForPresenceDialog(contact);
                } else if (!contact.getOption(com.orbit.call.entities.Contact.Options.TO)
                        || !contact.getOption(com.orbit.call.entities.Contact.Options.FROM)) {
    ...
    private UiCallback<Conversation> adhocCallback = new UiCallback<Conversation>() {
        ...
        public void success(final Conversation conversation) {
            ...
            getActivity().runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(getActivity(),R.string.conference_created,Toast.LENGTH_LONG).show();
                }
            });
        }
            ...
            nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
                ...
                public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
                    return new NdefMessage(new NdefRecord[]{
                            ...
                            NdefRecord.createApplicationRecord("com.persia.tech")
                    });
                }
            }, getActivity());
        }
    ...
    protected Bitmap createQrCodeBitmap(String input, int size) {
        android.util.Log.d(Config.LOGTAG, "qr code requested size: " + size);
        try {
            ...
            android.util.Log.d(Config.LOGTAG, "output size: " + width + "x" + height);
    ...
    class BitmapWorkerTask extends AsyncTask<com.orbit.call.entities.Message, Void, Bitmap> {
        private final WeakReference<ImageView> imageViewReference;
        private com.orbit.call.entities.Message message = null;
        ...
        @Override
        protected Bitmap doInBackground(com.orbit.call.entities.Message... params) {
            message = params[0];
            try {
    ...
    public void loadBitmap(com.orbit.call.entities.Message message, ImageView imageView) {
        Bitmap bm;
        try {
    ...
    public static boolean cancelPotentialWork(com.orbit.call.entities.Message message,
                                              ImageView imageView) {
        final BitmapWorkerTask bitmapWorkerTask = getBitmapWorkerTask(imageView);

        if (bitmapWorkerTask != null) {
            final com.orbit.call.entities.Message oldMessage = bitmapWorkerTask.message;
